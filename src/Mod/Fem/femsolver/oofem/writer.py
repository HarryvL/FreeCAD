...
# import feminout.importOOFEMMesh as importOOFEMMesh Used in Z88, but not in CCX. No need here?
...
class FemInputWriterOOFEM(FemInputWriter.FemInputWriter):
    def __init__(self,
        ...
        self.file_name = self.dir_name + '.in'
        FreeCAD.Console.PrintMessage('FemInputWriterOOFEM --> self.dir_name  -->  ' + self.dir_name + '\n')
        FreeCAD.Console.PrintMessage('FemInputWriterOOFEM --> self.file_name  -->  ' + self.file_name + '\n')

    def write_OOFEM_input(self):
